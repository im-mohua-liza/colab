...
module.exports = {
  content: ['./index.html', './about/index.html', './research/index.html', './design/index.html', './ecosystem/index.html', './projects/index.html', './contact/index.html', './faq/index.html', './js/*.js'],
  theme: {
    extend: {
      colors: {
